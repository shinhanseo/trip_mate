...
class _MeetingDetailPageState extends State<MeetingDetailPage> {
  ...
  Future<void> _showMeetingReportBottomSheet(BuildContext context) async {
    ...
    await showModalBottomSheet(
      ...
      builder: (sheetContext) => _MeetingReportBottomSheet(
...
class _MeetingReportBottomSheet extends StatefulWidget {
  const _MeetingReportBottomSheet({
    required this.targetMeetingId,
    required this.reportViewModel,
  });

  final int targetMeetingId;
  final ReportViewModel reportViewModel;

  @override
  State<_MeetingReportBottomSheet> createState() =>
      _MeetingReportBottomSheetState();
}

class _MeetingReportBottomSheetState extends State<_MeetingReportBottomSheet> {
  ...
  Future<void> _submit() async {
    ...
    final success = await widget.reportViewModel.createReport(
      ...
      targetId: widget.targetMeetingId,
